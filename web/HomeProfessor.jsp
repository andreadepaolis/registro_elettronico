        ...
        <div class="col-sm-6" align="center" style="border:0px">
            ...
            <form action="HomeProfessorServlet" method="post">
                ...
                <div class="col-sm-12 row" style="padding: 0px 20px">
                        <input class="col-sm-7" type="text" style= "border-radius: 5px; border:0px" placeholder="Insert Homework" name="descrizione">
                    <div class="col-sm-3">
                ...
                <div style="padding:0px 15px 15px 15px">
                    ...
                    <form action="HomeProfessorServlet" method="post">
                        ...
                        <div class="col-sm-12 row" style="padding:0px">
                            <input class="col-sm-7" style="background-color: white !important; border-radius: 5px; border:0px" type="text" name="description" placeholder="Insert an argument and click enter">
                            <div class="col-sm-3">
                            <select name ="materia">
                            <% for(String s: p.getMatter()){ %>
                            <option value ="<%=s%>">
